...
public class c1_Introduction extends IntroductionBase {
    ...
    public void nothing_happens_until_you_() throws InterruptedException {
        ...
        // Answer: Have to wait for serviceResult to emit the values, might happen immediately
        //          Or might happen in some time after test/program ends.
